...
$$
\begin{aligned}
\sum_{t=1}^{T} \alpha_{t}\left\langle x_{t}-y_{t}, g_{t}-M_{t}\right\rangle & \leq \sum_{t=1}^{T} \alpha_{t}\left\|g_{t}-M_{t}\right\|_{*}\left\|x_{t}-y_{t}\right\| \quad \text{ (Hölder's Inequality) } \\
